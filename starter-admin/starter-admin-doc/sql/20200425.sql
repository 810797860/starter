...
INSERT INTO `s_base_button` VALUES (27, '刷新字段', 'refresh', 'layui-icon layui-icon-refresh', 'refresh();\r\n                layer.msg(\'刷新成功\');', 1, NULL, '刷新字段', b'0', NULL, '2020-04-08 21:14:56', NULL, '2020-04-08 21:16:00');
INSERT INTO `s_base_button` VALUES (28, '增加字段', 'add', 'layui-icon layui-icon-add-1', '//跳转到新增页面\r\n                var index = parent.parent.layer.open({\r\n                    type: 2\r\n                    ,title: \'新增字段\'\r\n                    ,content: \'/admin/formField/\' + formId + \'/create.html\'\r\n                    ,maxmin: true\r\n                    ,area: [\'550px\', \'550px\']\r\n                    ,btn: [\'确定\', \'取消\']\r\n                    ,yes: function (index, layro) {\r\n                        var submit = layro.find(\'iframe\').contents().find(\'#modifyBtn\');\r\n                        submit.click();\r\n                        layer.msg(\"新增成功\");\r\n                    }\r\n                });\r\n                //窗口默认最大化\r\n                parent.parent.layer.full(index);', 2, NULL, '增加字段', b'0', NULL, '2020-04-08 21:16:23', NULL, '2020-04-08 21:18:41');
INSERT INTO `s_base_button` VALUES (29, '修改字段', 'update', 'layui-icon layui-icon-edit', 'if(data.length === 0){\r\n                    layer.msg(\'请选择一行\');\r\n                } else if(data.length > 1){\r\n                    layer.msg(\'只能同时修改一个\');\r\n                } else {\r\n                    updateOperation(checkStatus.data[0].id);\r\n                }', 3, NULL, '修改字段', b'0', NULL, '2020-04-08 21:19:01', NULL, '2020-04-08 21:19:29');
INSERT INTO `s_base_button` VALUES (30, '删除字段', 'delete', 'layui-icon layui-icon-delete', 'if(data.length === 0){\r\n        layer.msg(\'请选择一行\');\r\n    } else {\r\n        //先获取要删除的行\r\n        var dataList = checkStatus.data,\r\n            deleteParam = [];\r\n        for (var i = 0; i < dataList.length; i++){\r\n            deleteParam.push(dataList[i].id);\r\n        }\r\n        ojbk.putAjax(\'/admin/form/batch_delete\', deleteParam, function (data) {\r\n            switch (data.code) {\r\n                case 200:\r\n                    refresh();\r\n                    layer.msg(\'删除成功\');\r\n                    break;\r\n            }\r\n        });\r\n    }', 4, NULL, '删除字段', b'0', NULL, '2020-04-08 21:19:52', NULL, '2020-04-11 14:46:02');
INSERT INTO `s_base_button` VALUES (31, '搜索字段', 'search', 'layui-icon layui-icon-search', '//展开搜索项\r\n                $(\"#ojbk-search\").show();', 5, NULL, '搜索字段', b'0', NULL, '2020-04-09 20:12:42', NULL, '2020-04-09 20:13:03');
INSERT INTO `s_base_button` VALUES (32, '刷新用户', 'refresh', 'layui-icon layui-icon-refresh', 'refresh();\r\n                layer.msg(\'刷新成功\');', 1, NULL, '刷新用户', b'0', NULL, '2020-04-11 20:31:39', NULL, '2020-04-11 20:34:29');
INSERT INTO `s_base_button` VALUES (33, '增加用户', 'add', 'layui-icon layui-icon-add-1', '//跳转到新增页面\r\n                layer.open({\r\n                    type: 2\r\n                    ,title: \'新增表单\'\r\n                    ,content: [\'/admin/user/create.html?id=\', \'no\']\r\n                    ,maxmin: true\r\n                    ,area: [\'550px\', \'550px\']\r\n                    ,btn: [\'确定\', \'取消\']\r\n                    ,yes: function (index, layro) {\r\n                        var submit = layro.find(\'iframe\').contents().find(\'#modifyBtn\');\r\n                        submit.click();\r\n                    }\r\n                });', 2, NULL, '增加用户', b'0', NULL, '2020-04-11 20:34:32', NULL, '2020-04-11 20:35:10');
INSERT INTO `s_base_button` VALUES (34, '修改用户', 'update', 'layui-icon layui-icon-edit', 'if(data.length === 0){\r\n                    layer.msg(\'请选择一行\');\r\n                } else if(data.length > 1){\r\n                    layer.msg(\'只能同时修改一个\');\r\n                } else {\r\n                    //跳转到修改页面\r\n                    var index = layer.open({\r\n                        type: 2\r\n                        ,title: \'修改表单\'\r\n                        ,content: \'/admin/user/\' + checkStatus.data[0].id + \'/update.html\'\r\n                        ,maxmin: true\r\n                        ,area: [\'550px\', \'550px\']\r\n                        ,btn: [\'确定\', \'取消\']\r\n                        ,yes: function (index, layro) {\r\n                            var submit = layro.find(\'iframe\').contents().find(\'#modifyBtn\');\r\n                            submit.click();\r\n                            layer.msg(\'修改成功\');\r\n                        }\r\n                    });\r\n                    //窗口默认最大化\r\n                    layer.full(index);\r\n                }', 3, NULL, '修改用户', b'0', NULL, '2020-04-11 20:35:35', NULL, '2020-04-11 20:36:42');
INSERT INTO `s_base_button` VALUES (35, '分配角色', 'distribution', 'layui-icon layui-icon-edit', 'if(data.length === 0){\r\n        layer.msg(\'请选择一行\');\r\n    } else if(data.length > 1){\r\n        layer.msg(\'只能同时分配一个\');\r\n    } else {\r\n        //跳转到修改页面\r\n        var index = layer.open({\r\n            type: 2\r\n            ,title: \'分配角色\'\r\n            ,content: \'/admin/userRole/\' + checkStatus.data[0].id + \'/create.html\'\r\n            ,maxmin: true\r\n            ,area: [\'550px\', \'550px\']\r\n            ,btn: [\'确定\', \'取消\']\r\n            ,yes: function (index, layro) {\r\n                var submit = layro.find(\'iframe\').contents().find(\'#modifyBtn\');\r\n                submit.click();\r\n                layer.msg(\'修改成功\');\r\n            }\r\n        });\r\n        //窗口默认最大化\r\n        layer.full(index);\r\n    }', 4, NULL, '分配角色', b'0', NULL, '2020-04-11 20:37:00', NULL, '2020-04-12 17:00:40');
INSERT INTO `s_base_button` VALUES (36, '删除用户', 'delete', 'layui-icon layui-icon-delete', 'if(data.length === 0){\r\n                    layer.msg(\'请选择一行\');\r\n                } else {\r\n                    //先获取要删除的行\r\n                    var dataList = checkStatus.data,\r\n                        deleteParam = [];\r\n                    for (var i = 0; i < dataList.length; i++){\r\n                        deleteParam.push(dataList[i].id);\r\n                    }\r\n\r\n                    //开始删除\r\n                    ojbk.putAjax(\'/admin/user/batch_delete\', deleteParam, function (data) {\r\n                        switch (data.code) {\r\n                            case 200:\r\n                                refresh();\r\n                                layer.msg(\'删除成功\');\r\n                                break;\r\n                        }\r\n                    });\r\n                }', 5, NULL, '删除用户', b'0', NULL, '2020-04-12 11:44:34', NULL, '2020-04-12 16:27:21');
INSERT INTO `s_base_button` VALUES (37, '搜索用户', 'search', 'layui-icon layui-icon-search', '//展开搜索项\r\n                $(\"#ojbk-search\").show();', 6, NULL, '搜索用户', b'0', NULL, '2020-04-12 16:26:46', NULL, '2020-04-12 16:27:08');
INSERT INTO `s_base_button` VALUES (38, '刷新按钮', 'refresh', 'layui-icon layui-icon-refresh', 'refresh();\r\n                layer.msg(\'刷新成功\');', 1, NULL, '刷新按钮', b'0', NULL, '2020-04-21 20:55:29', NULL, '2020-04-21 20:57:43');
INSERT INTO `s_base_button` VALUES (39, '增加按钮', 'add', 'layui-icon layui-icon-add-1', '//跳转到新增页面\r\n                layer.open({\r\n                    type: 2\r\n                    ,title: \'新增按钮\'\r\n                    ,content: [\'/admin/button/create.html?id=\', \'no\']\r\n                    ,maxmin: true\r\n                    ,area: [\'550px\', \'550px\']\r\n                    ,btn: [\'确定\', \'取消\']\r\n                    ,yes: function (index, layro) {\r\n                        var submit = layro.find(\'iframe\').contents().find(\'#modifyBtn\');\r\n                        submit.click();\r\n                    }\r\n                });', 2, NULL, '增加按钮', b'0', NULL, '2020-04-21 21:04:49', NULL, '2020-04-21 21:05:47');
INSERT INTO `s_base_button` VALUES (40, '修改按钮', 'update', 'layui-icon layui-icon-edit', 'if(data.length === 0){\r\n                    layer.msg(\'请选择一行\');\r\n                } else if(data.length > 1){\r\n                    layer.msg(\'只能同时修改一个\');\r\n                } else {\r\n                    //跳转到修改页面\r\n                    var index = layer.open({\r\n                        type: 2\r\n                        ,title: \'修改按钮\'\r\n                        ,content: \'/admin/button/\' + checkStatus.data[0].id + \'/update.html\'\r\n                        ,maxmin: true\r\n                        ,area: [\'550px\', \'550px\']\r\n                        ,btn: [\'确定\', \'取消\']\r\n                        ,yes: function (index, layro) {\r\n                            var submit = layro.find(\'iframe\').contents().find(\'#modifyBtn\');\r\n                            submit.click();\r\n                            layer.msg(\'修改成功\');\r\n                        }\r\n                    });\r\n                    //窗口默认最大化\r\n                    layer.full(index);\r\n                }', 3, NULL, '修改按钮', b'0', NULL, '2020-04-21 21:09:50', NULL, '2020-04-21 21:13:44');
INSERT INTO `s_base_button` VALUES (41, '删除按钮', 'delete', 'layui-icon layui-icon-delete', 'if(data.length === 0){\r\n                    layer.msg(\'请选择一行\');\r\n                } else {\r\n                    //先获取要删除的行\r\n                    var dataList = checkStatus.data,\r\n                        deleteParam = [];\r\n                    for (var i = 0; i < dataList.length; i++){\r\n                        deleteParam.push(dataList[i].id);\r\n                    }\r\n\r\n                    //开始删除\r\n                    ojbk.putAjax(\'/admin/button/batch_delete\', deleteParam, function (data) {\r\n                        switch (data.code) {\r\n                            case 200:\r\n                                refresh();\r\n                                layer.msg(\'删除成功\');\r\n                                break;\r\n                        }\r\n                    });\r\n                }', 4, NULL, '删除按钮', b'0', NULL, '2020-04-21 21:15:55', NULL, '2020-04-21 21:16:35');
INSERT INTO `s_base_button` VALUES (42, '搜索按钮', 'search', 'layui-icon layui-icon-search', '//展开搜索项\n                $(\"#ojbk-search\").show();', 5, NULL, '搜索按钮', b'0', NULL, '2020-04-21 21:16:51', NULL, '2020-04-25 17:09:15');
...
-- ----------------------------
INSERT INTO `s_base_menu_button` VALUES (105, 1, NULL, NULL, b'1', NULL, '2018-12-09 15:24:13', NULL, '2020-04-22 20:17:12');
INSERT INTO `s_base_menu_button` VALUES (105, 2, NULL, NULL, b'1', NULL, '2018-12-09 15:24:16', NULL, '2020-04-22 20:17:12');
INSERT INTO `s_base_role_button` VALUES (1, 32, NULL, NULL, b'0', NULL, '2020-04-12 11:46:24', NULL, '2020-04-12 11:46:24');
INSERT INTO `s_base_role_button` VALUES (1, 33, NULL, NULL, b'0', NULL, '2020-04-12 11:46:28', NULL, '2020-04-12 11:46:28');
INSERT INTO `s_base_role_button` VALUES (1, 34, NULL, NULL, b'0', NULL, '2020-04-12 11:46:31', NULL, '2020-04-12 11:46:31');
INSERT INTO `s_base_role_button` VALUES (1, 35, NULL, NULL, b'0', NULL, '2020-04-12 11:46:33', NULL, '2020-04-12 11:46:33');
INSERT INTO `s_base_role_button` VALUES (1, 36, NULL, NULL, b'0', NULL, '2020-04-12 11:46:36', NULL, '2020-04-12 11:46:36');
INSERT INTO `s_base_role_button` VALUES (1, 37, NULL, NULL, b'0', NULL, '2020-04-12 16:43:51', NULL, '2020-04-12 16:43:51');
INSERT INTO `s_base_role_button` VALUES (1, 38, NULL, NULL, b'0', NULL, '2020-04-22 19:19:53', NULL, '2020-04-22 19:19:53');
INSERT INTO `s_base_role_button` VALUES (1, 39, NULL, NULL, b'0', NULL, '2020-04-22 19:19:58', NULL, '2020-04-22 19:19:58');
INSERT INTO `s_base_role_button` VALUES (1, 40, NULL, NULL, b'0', NULL, '2020-04-22 19:20:01', NULL, '2020-04-22 19:20:01');
INSERT INTO `s_base_role_button` VALUES (1, 41, NULL, NULL, b'0', NULL, '2020-04-22 19:20:05', NULL, '2020-04-22 19:20:05');
INSERT INTO `s_base_role_button` VALUES (1, 42, NULL, NULL, b'0', NULL, '2020-04-22 19:20:08', NULL, '2020-04-22 19:20:08');
...
CREATE TABLE `s_base_user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 60 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '管理员表' ROW_FORMAT = Dynamic;
...
INSERT INTO `s_base_user` VALUES (57, NULL, 'test123', 'ZEr559FnMAo=', 'test123', NULL, '13789456123@163.com', '13789456123', 100505, 'c48734e0e9b04b92bcbd0ea6b8d68bda', 0, NULL, NULL, b'0', NULL, '2020-04-12 12:57:45', NULL, '2020-04-12 12:58:10');
INSERT INTO `s_base_user` VALUES (58, NULL, 'test234', 'ZEr559FnMAo=', 'test234', NULL, '13123456789@163.com', '13123456789', 100505, '37ae741d88eb43808a76d694c57c6113', 0, NULL, NULL, b'0', NULL, '2020-04-12 13:01:19', NULL, '2020-04-12 13:01:19');
INSERT INTO `s_base_user` VALUES (59, NULL, 'test210', NULL, 'test210', NULL, '13123456789@163.com', '13123456789', 100505, '87e993eaafc04ca7b7ef4f77a166814e', 0, NULL, NULL, b'0', NULL, '2020-04-12 15:45:42', NULL, '2020-04-12 15:53:54');
...
INSERT INTO `s_base_user_role` VALUES (57, 4, 'fa623844ce194e2e992a1164dabd50b1', NULL, b'0', NULL, '2020-04-12 12:57:45', NULL, '2020-04-12 12:57:45');
INSERT INTO `s_base_user_role` VALUES (58, 4, '6f1430da55984fd89534cc5efc331936', NULL, b'0', NULL, '2020-04-12 13:01:19', NULL, '2020-04-12 13:01:19');
INSERT INTO `s_base_user_role` VALUES (59, 4, '3b92258b1ff7422492914a12035a80ee', NULL, b'0', NULL, '2020-04-14 21:15:38', NULL, '2020-04-14 21:15:38');
